...
# job name
             logfile =  growth01.log   ! file to which output is directed
            dumpfile =  growth_00000   ! dump file to start from
...
# options controlling dust (1 dust species)
           ...
           graindens =       1.000    ! Intrinsic grain density in g/cm^3
              irecon =           1    ! use reconstruction in gas/dust drag (-1=off,0=no slope limiter,1=van leer MC)
   icut_backreaction =           0    ! cut the drag on the gas phase (0=no, 1=yes)

# options controlling growth
             wbymass =           T    ! weight dustgasprops by mass rather than mass/density
